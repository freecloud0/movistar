    ...
    public function index(Request $request)
    {
        // return $request;
         ...
         if ($buscar=='') {
             ...
             'ctproduc.estado','ctproduc.ctproduct_stock_max as stockMaximo')
             ...
             'ctproduc.ctproduc_fecha_act','ctproduc.ctproduc_usuario','ctproduc.estado','ctproduc.ctproduct_stock_max as stockMaximo')
