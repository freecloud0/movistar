...
class ReporteController extends Controller
{
    ...
    {
        $fecha=$request->fecha;
        $user=ReporteSalida::join('ctproduc','ctproduc.ctproduc_id','=','ctreportesa_producId')
        ->join('ctundmd','ctundmd.ctundmd_code','=','ctproduc.ctproduc_undMed')
        ->where('ctreportesa_fechareg',$fecha)
        ->select('ctproduc.sap','ctreportesa.ctreportesa_fechatime','ctreportesa.ctreportesa_user',
        'ctreportesa.ctreportesa_cantidad','ctundmd.ctundmd_desc','ctreportesa.ctreportesa_serie')
        ->orderby('ctreportesa_fechatime','desc')
        ->get();
        return $user;
