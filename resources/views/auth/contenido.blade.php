...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="ca/img/core-img/favicon.ico">

    <!-- Core Stylesheet -->
    <link href="ca/style.css" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">
    <!-- Responsive CSS -->
    <link href="ca/css/responsive.css" rel="stylesheet">
...
<body>
                ...
                <div class="col-12 col-lg-10">
                    <div class="menu_area">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <!-- Logo -->
                            <a class="logoT p-4" ><i class="fas fa-lock icoEr"></i> ELINIK <span class="stLo">TECH</span></a>
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                ...
                                <div class="sing-up-button d-lg-none">
                                    <a href="{{ url('iniciar-sesion') }}">Ingresar</a>
                                </div>
                            </div>
                        </nav>
                    </div>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    <div class="wellcome-heading">
                        <h2>ELINIKTECH</h2>
                        <h3>C</h3>
                        <p>Con más de 12 años de experiencia en instalación de infraestructura física de redes</p>
                    </div>
    ...
    <footer class="footer-social-icon text-center section_padding_70 clearfix">
        ...
        <div class="copyright-text">
            ...
            <p>Copyright ©2018 Ca. Designed by <span><img class="logoFr" src="img/logoFree.svg" alt=""></span></p>
        </div>
    </footer>
    <!-- ***** Footer Area Start ***** -->

    <!-- Jquery-2.2.4 JS -->
    <script src="ca/js/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="ca/js/popper.min.js"></script>
    <!-- Bootstrap-4 Beta JS -->
    <script src="ca/js/bootstrap.min.js"></script>
    <!-- All Plugins JS -->
    <script src="ca/js/plugins.js"></script>
    <!-- Slick Slider Js-->
    <script src="ca/js/slick.min.js"></script>
    <!-- Footer Reveal JS -->
    <script src="ca/js/footer-reveal.min.js"></script>
    <!-- Active JS -->
    <script src="ca/js/active.js"></script>
</body>
