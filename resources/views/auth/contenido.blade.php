...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>HACEMOS TELECOMUNICACIONES</h1>
            <p class="tagline">Con más de 12 años de experiencia en instalación de infraestructura física de redes de transmisión Inalámbrica y Cableada, con alta especialización en soluciones con Fibra Óptica.
</p>
        </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">Nuestro pilar fundamental es la innovación tecnológica que nos permite dar un valor agregado a todos nuestros productos.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">Contamos con un área especializada en planimetría que nos permitió desarrollar la mayor cantidad de diseños de proyectos de dorsales de Fibra Óptica ejecutados para América Móvil, durante los últimos 05 años </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">A la fecha contamos con una experiencia mayor de 10,000 km en diseño ,construcción y mantenimiento seguras.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <p class="mb-2"> <span class="ti-location-pin mr-2"></span> Jr. Puno 213, Huancayo, Junin</p>
                    <div class=" d-block d-sm-inline-block">
                        <p class="mb-2">
                            <span class="ti-email mr-2"></span> <a class="mr-4" href="mailto:support@mobileapp.com">info@eliniktech.com</a>
                        </p>
                    </div>
                    <div class="d-block d-sm-inline-block">
                        <p class="mb-0">
                            <span class="ti-headphone-alt mr-2"></span> <a href="tel:51836362800">977646505</a>
                        </p>
                    </div>
    ...
    <footer class="my-5 text-center">
        ...
        <p class="mb-2"><small>COPYRIGHT © 2018. TODOS LOS DERECHOS RESERVADOS. DESARROLLADO POR <a href="https://www.facebook.com/freecloud.pe/">FREECLOUD</a></small></p>
    </footer>
