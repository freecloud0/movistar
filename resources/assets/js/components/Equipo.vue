            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md">
                                <button @click="pdfExportTotal()" type="submit" class=" float-right psoFs btn red">
                                    pdf<i class=" ml-2 fas fa-file-pdf conTd"></i>
                                </button>
                                <button @click="excelExportTotal()" type="submit" class=" float-right psoFs btn green">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-for="(equipo,indice) in arrayEquipo" :key="equipo.idCategoria"  >
                                    ...
                                    <td >
                                         <button @click="pdfExport(equipo.sap)" type="submit" class=" psoFs2 btn red">
                                            <i class=" fas fa-file-pdf conTd"></i>
                                        </button>
                                    </td>
                                     <td >
                                         <button @click="excelExport(equipo.sap)" type="submit" class="  psoFs2 btn green">
                                            <i class="  fas fa-file-excel conTd"></i>
                                        </button>
                                    </td>
                                     <td v-if="CargoUser==1" class="text-center">
