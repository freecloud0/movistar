            ...
            <div class="container-fluid">
                ...
                <div class="">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 busq p-2">
                                    ...
                                    <div class="col-1 visible-wE">
                                        <button :disabled="buscar == ''" @click="listarAlmacen(1,buscar,criterio)" type="button" class="psoFSal btn green btn-sm ">
                        ...
                        <div class="bg-grasy card" v-for="(almacen,indice) in arrayAlmacen" :key="almacen.idalmacen">
                            ...
                            <div class="body-tableR">
                                <div class="row">
                                    <div class="col-md-4 ">
                                        ...
                                        <div class="ml-4">
                                            <i class="b-01 icoC-text ml-2">Serie:</i>
                                            <span class="b-01 black-text">
                                                {{almacen.ctdetsa_serie}}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-8 ">
                                        <div class="text-right">
                                            <span class="text-dr visible-wE">
                                                <i class="far fa-calendar-alt red-text mr-2"></i>
                                                {{almacen.ctdetsa_fecha_reg}}
                                            </span>

                                            <span class="text-right">{{restantes(almacen.ctdetsa_fecha_reg)}}</span> <span class="b-01 ">
                                                /3 dias
                                            </span>
                                        </div>
                                        
                                        <b-progress :value="controlT(restantes(almacen.ctdetsa_fecha_reg))"
                                                    :variant="estadoS(restantes(almacen.ctdetsa_fecha_reg))" 
                                                    class="mb-3">
                                        </b-progress>
                                    </div>
                                </div>
                            ...
                            <nav aria-label="pagination example mt-4">
        ...
        methods:{
            ...
            listarAlmacen(page,buscar,criterio){
               ...
               axios.get(url).then(function (response) {
                    ...
                    // }
                    // if (response.data.dias.length==1) {
                    //      serie =response.data.dias[0].series;
                    //      dia=response.data.dias[0].dias;
                    //      toast({
                    //     type: 'warning',
                    //     title: `producto pendiente serie: ${serie} dia: ${dia}`
                    // })
                    // }else if(response.data.dias.length>1){
                    //      serie =response.data.dias.series;
                    // toast({
                    //     type: 'warning',
                    //     title: `productos pendientes series ${serie}`
                    // })
                    // }
                    var respuesta=response.data;
                   me.arrayAlmacen=respuesta.almacen.data;
                   me.siguienteDia=respuesta.dias.dias;
