<template>
     ...
     <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">       
            <li class="nav-item " @click="metodoverdias()" >
                <!-- <i class="icon-bell" ></i> -->
                <!-- <a class="nav-link" aria-haspopup="true" aria-expanded="false" @click.prevent="equis=1" >
                    
                    <i class="icon-bell" id="alC"></i>
                        <span class="badge badge-pill red">{{arrayDias.length}}</span>
                </a> -->
                <button 
                        @click.prevent="equis=1"
                        type="button" class="redondear2 btn-transparent red pb-2 pt-2" >
                        <i class="icon-bell" ></i>
                        <span class="padba b-01 white redondear3 black-text">{{arrayDias.length}}</span>
                </button>
