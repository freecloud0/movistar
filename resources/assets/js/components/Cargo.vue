                ...
                <div class="">
                    <div class="card-header hedCa white-text">
                        ...
                        <div class="float-right">
                            <button v-b-tooltip.hover title="Agregar Cargo" 
                            ...
                            <div class="col-md-6 busq p-2 card">
                                <div class="row">
                                    ...
                                    <div class="col-1 visible-wE">
                                        <button :disabled="buscar == ''" @keyup="listarCargo(1,buscar,criterio)" type="button" class="psoFSal btn green btn-sm ">
                ...
                <div class="modal-dialog " role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title white-text b-01" v-text="tituloModal"></h4>
