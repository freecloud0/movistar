                                                ...
                                                <!-- {{arrayEquiEn}} -->
                                                     ...
                                                     <div class="row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <input type="text" :class="{  brd: this.arrayEquiEn.length<1 , werd:this.arrayEquiEn.length>1 }"  v-on:keyup.enter="listarProductoEncontrar(buscarSap02)"  v-model="buscarSap02"  class="form-control" >
                                                                <div class="filesxPos " :class="{disNo:this.arrayEquiEn.length<1 , disBlo:this.arrayEquiEn.length>1}">Datos encontrados</div>
                                                                <div class="filesx " :class="{disBlo:this.arrayEquiEn.length<1 , disNo:this.arrayEquiEn.length>1}">No registrado</div>
                                                        </div>
                                                        <div class="col-md-2">
                                                           <br>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-10">
                                                                <!-- {{arrayEquiEn}} -->
                                                                <br>
                                                                <div :class="{ disNo: this.arrayEquiEn=='' , disBlo: this.arrayEquiEn.length<1 }" > 
                                                                    ...
                                                                    <input type="text" :disabled="ControlSer"  v-model="buscar05" @keyup="buscarInfo()" class="form-control " >  
                                                                </div>
                                                            </div>
                                                        </div>
