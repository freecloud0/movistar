                    ...
                    <template  v-if="listado==3">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md transA" v-if="devLis==0" >
                                    <div class="card p-2">
                                         <span class="b-01 black-text m-2"><i  class="orange-text fas fa-exclamation-triangle mr-2"></i> Los productos se mostraran pasados los 13 dias o no esten despachados</span>
