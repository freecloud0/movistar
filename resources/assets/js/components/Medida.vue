<template>
                            ...
                            <div class="col-md-6 busq p-2 card">
                                <div class="row">
                                    ...
                                    <div class="col-1 visible-wE">
                                        <button :disabled="buscar == ''" @keyup="listarMedida(1,buscar,criterio)" type="button" class="psoFSal btn green btn-sm ">
            ...
            <b-modal v-model="modallg" no-close-on-esc no-close-on-backdrop  id="modallg"  title="Unidad de Medida" tabindex="-1" :class="{'mostrar':modal}">
