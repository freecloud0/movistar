                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <b-card bg-variant="white"
                                                ...
                                                <br>
                                                <input class="form-control" v-model="serieInput" @keyup="agregarSerie(this.serieInput)" type="text">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="anyClass border-r p-4 mb-4" :class="{disNo:this.probarinsertDevolucion=='' ,disBlo:this.probarinsertDevolucion!=''}">
        ...
        methods:{
            ...
            agregarSerie(serie){
                ...
                for (let i = 0; i < this.arraySeriesDevolucion.length; i++) {
                    const element =  this.arraySeriesDevolucion[i].ctdetgu_serieProduc;
                    const estado =  this.arraySeriesDevolucion[i].ctdetgu_code;
                        ...
                        if (this.serieInput==element) {
                            if (estado==2) {
                                ...
                                swal({
                                    type:'error',
                                    title:'Error...',
                                    text:'Este producto aun no ha sido despachado',
                                });
                                this.serieInput=''
                                return
                            }
