            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="div" v-show="equist==1"><i class="fa fa-align-justify"></i> Liquidacion</div>
                                <div class="div" v-show="equist==2"><i class="fa fa-align-justify"></i> Devolucion</div>
                            ...
                            <div class="col">
                             <button type="button" @click="mostrarDetalle()" class="btn orange float-right  btn-sm"  >
                                <i class="icon-plus"></i>&nbsp;Nuevo
                                    ...
                                    <button type="submit" :disabled="equist==1" class=" float-right psoFs btn red mb-2" @click.prevent="equist=1">
                                        Liquidacion
                                    </button>
                                    <button type="submit" :disabled="equist==2" class=" float-right psoFs btn blue mb-2" @click.prevent="equist=2">
                                        Devolucion
                                    </button>
                            </div>
                        </div>
                    ...
                    <div class="card-body" v-show="equist==1">
                        <div class="row">
                    ...
                    <div class="card-body" v-show="equist==2">
                        <input v-model="serieInput" @keyup="agregarSerie(serieInput)" type="text">
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="anyClass border-r p-4" :class="{disNo:this.probarinsertDevolucion=='' ,disBlo:this.probarinsertDevolucion!=''}">
                                    <h6 class="p-2 b-01 text-center">Lista de Devolución</h6>
                                    <table class="table table-bordered table-striped table-sm">
                                        <thead>
                                            <tr> 
                                                <th>Equipos</th>
                                                ...
                                                <th>
                                                    <div class="btn-group ">
                                                        <button type="button" v-b-tooltip.hover title="Limpiar Liquidación"  @click="probarinsertDevolucion=[]" class=" btn-transparent blue-text">
                                                            <i class="fas fa-eraser"></i>
                                                        </button>
                                                    </div>
                                        ...
                                        <tbody class=" ">
                                            <tr v-for="(series, index) in probarinsertDevolucion" :key="index">
                                                <td>
                                                    {{series.Numeroserie}}
                                                     {{series.UserD}}
                                                    <!-- <p hidden="hidden">{{index +1}}</p> -->
                                                ...
                                                <td>
                                                    <div class="btn-group ">
                                                        <button type="button" @click="eliminarIndexDevolucion(index)" class=" btn-transparent red-text">
                                                            <i class="fas fa-backspace"></i>
                                                        </button>
                                                    </div>
                                                    <!-- <a @click="eliminarIndex(index)"> eliminar</a> -->
                                ...
                                <button class="btn orange float-c mt-2 btn-sm" @click="devolucionProductos(probarinsertDevolucion)">Devolver Todo</button>
                         ...
                         <div  class="table-responsive">
                            <table @click="mostrarLista()" class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="salida in arrayListarSerie" :key="salida.idseriesalida"  >
                                        
                                        <td v-text="salida.ctdetsa_sap" ></td>
                                        <td v-text="salida.ctdetsa_serie"></td>
                                        <td v-text="salida.ctdetgu_fecha_reg"></td> 
        ...
        methods:{
                ...
                for (let i = 0; i < this.arraySeriesDevolucion.length; i++) {
                    ...
                    if (this.serieInput != null) {
                        ...
                        if (this.serieInput==element) {
                                this.probarinsertDevolucion.push({Numeroserie:this.serieInput,UserD:devolucionUser});
                                this.serieInput='';
            ...
            mostrarLista(){
              ...
              devolucionProductos(serie){
                 ...
                 if (this.probarinsertDevolucion.length ==0) {
                      toast({
                        type: 'warning',
