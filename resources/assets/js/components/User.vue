            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button @click="abrirModal('usuario','registrar')"   type="button" class="btn blue btn-sm float-right" data-toggle="modal" data-target="#basicExampleModal">
                            ...
                            <b-card no-body class="mb-1">
                                <b-card-header header-tag="header" class="p-1" role="tab">
                                    ...
                                    <template slot="title">Alerta</template>
                                        ...
                                        <div class="text-danger" v-show="usuario.length < 2">Rellene Campo  Usuario</div>
                                        <div class="text-danger" v-show="emailC.length < 2">Rellene Campo  Email</div>
                                        <div class="text-danger" v-show="password .length<2">Rellene Campo de COntraseña</div>
                                ...
                                <div class="boton" v-if="errores.ctusuar_usuario" >
                                    <i id="exPopover6"  class="retr red-text fas fa-exclamation-triangle"></i>
                                    
                                    <b-popover target="exPopover6" triggers="hover focus">
                                    <template slot="title">Alerta</template>
                                       
                                        <div class="text-danger">Nombre de Usuario ya existente</div>
