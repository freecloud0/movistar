                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md">
                                <button @click="pdfExport()" type="submit" class=" float-right psoFs btn red">
                                    pdf<i class=" ml-2 fas fa-file-pdf conTd"></i>
                                </button>
                                <button @click="excelExport()" type="submit" class=" float-right psoFs btn green">
                                    excel<i class=" ml-2 fas fa-file-excel conTd"></i>
                                </button>
                        </div>
                        </div>
                                                               ...
                                                               <div class="row">
                                                                   ...
                                                                   <div class="col-md-6">
                                                                       <table class="table table-bordered">
                                                                           ...
                                                                           <tbody>
                                                                               <tr>
                                                                                   <td><span class="green-text b-01">{{arraM02()}}</span></td>
                                                                                   <td class="b-01">{{metodoLimiteStock()}}</td>
                                                                                   <td class="b-01">{{stockDisponible()}}</td>
                                                                               </tr>
                                                                           </tbody>
                                                                       </table>
                                                                   </div>
          ...
          // Exportar En archivo excel metodo
            excelExport(){
                 Swal({
                        ...
                        if (result.value) {
                        window.open(url+'excel-ingresos');
                        }
                    });
