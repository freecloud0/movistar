                                                ...
                                                <b-tab title="Equipo" active>
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <input type="text" :disabled="nroComprobante == ''||serie==''" ref="emailss" v-model="buscar" @keyup.enter="listarSAP(buscar,criterio1)" class="form-control" placeholder="Texto a buscar">  
                                                            <span ></span>
                                                        <!-- {{arraySAP}} -->
                                                        </div>
                                                        <div class="col-md-2">
