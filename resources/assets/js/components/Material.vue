                                ...
                                <tbody>
                                    ...
                                    <tr v-for="material in arrayMaterial" :key="material.idCategoria"  >
                                        ...
                                        <td class="text-center">
                                               {{material.ctproduc_stock}} / <span class="blue-text b-01">{{material.stockMaximo}}<i class=" ml-2 fas fa-box-open"></i></span>
           ...
           //  return val-val2;
            ...
            excelExport(){
                 Swal({
                        ...
                        if (result.value) {
                        window.open(url+'excel-material');
                        }
                    });
