<template>
                ...
                <div class="card">
                    <div class="card-header hedCa white-text">
                        ...
                        <div class="float-right">
                            <button v-b-tooltip.hover title="Agregar Proveedores" 
                                    v-b-modal.modallg
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 busq p-2 card">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-1 visible-wE">
                                        <button :disabled="buscar == ''" @keyup="listarProveedor(1,buscar,criterio)" type="button" class="psoFSal btn green btn-sm ">
        ...
        <b-modal no-close-on-esc no-close-on-backdrop v-model="modallg" id="modallg" size="lg" title="Proveedor" tabindex="-1" :class="{'mostrar':modal}">
